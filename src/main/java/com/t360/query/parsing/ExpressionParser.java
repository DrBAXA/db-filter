...
import static com.t360.query.filtering.LogicalOperator.AND;
import static com.t360.query.filtering.LogicalOperator.OR;
...
public class ExpressionParser {
	...
	public Node parse(String expression) {
		if (expression.length() > MAX_EXPRESSION_LENGTH)
			throw new IllegalArgumentException("Too long expression");
	 ...
	 * @param i
	 *            index of a first character after opening bracket. E.g. position to start
